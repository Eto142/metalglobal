...
<tr>
    <td align='center'>
       ...
       <tr>
        ...
        <img width='100' border='0' style='display: block; width: 300px;' src="{{asset('logo2.png')}}"/></a>
             </td>
         </tr>
        </table>
                </td>
                                    ...
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        ...
                                        <p style='line-height: 24px; margin-bottom:20px;'>
                                            Connect with our media personnel if you are running into problems at
                                             <a href='mailto:support@standardoptions.net ' style='color: blue; font-size: 20px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>support@standardoptions.net</a>
                                        </p>
                                        <br/> 
