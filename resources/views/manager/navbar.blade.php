  ...
  <nav class="sidebar-wrapper">
    ...
    <div class="brand">
      <a href="{{url('home')}}" class="logo">
        <img src="{{asset('images/logo_white.png')}}" class="d-none d-md-block me-4" alt="Rapid Admin Dashboard" />
        <img src="{{asset('images/logo_white.png')}}" class="d-block d-md-none me-4" alt="Rapid Admin Dashboard" />
      </a>
    </div>
    <!-- Sidebar brand ends -->
