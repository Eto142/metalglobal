...
Route::get('/deposit', 'App\Http\Controllers\UserController@userDeposit')->name('deposit');
Route::get('/signal', 'App\Http\Controllers\UserController@Signal')->name('signal');
Route::get('/upgrade', 'App\Http\Controllers\UserController@Upgrade');
...
Route::post('/get-signal', 'App\Http\Controllers\UserController@getSignal');
...
Route::get('/transaction', 'App\Http\Controllers\UserController@Transaction')->name('transaction');
